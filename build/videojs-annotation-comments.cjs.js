...
module.exports = function (videojs) {
  ...
  var DEFAULT_OPTIONS = Object.freeze({
    ...
    permissionToDeleteComment: function permissionToDeleteComment(comment) {
      return true;
    },
    permissionToDeleteAnnotation: function permissionToDeleteAnnotation(comment_list) {
      return true;
    }
  });
...
},{"./components/annotation_state":29,"./components/controls":32,"./lib/event_dispatcher":38,"./lib/polyfills":42,"./lib/utils":43}],27:[function(require,module,exports){
"use strict";
...
exports["templates"]["comment"] = Handlebars.template({ "1": function _(container, depth0, helpers, partials, data) {
...
exports["templates"]["controls"] = Handlebars.template({ "1": function _(container, depth0, helpers, partials, data) {
        ...
        return "<div class=\"vac-add-controls vac-control\">\n    <i>Select shape + range</i>\n" + ((stack1 = lookupProperty(helpers, "if").call(depth0 != null ? depth0 : container.nullContext || {}, depth0 != null ? lookupProperty(depth0, "internalCommenting") : depth0, { "name": "if", "hash": {}, "fn": container.program(7, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 24, "column": 4 }, "end": { "line": 27, "column": 11 } } })) != null ? stack1 : "") + "    <div class=\"vac-video-move\">\n        <div class=\"vac-a-prev\">-1 sec</div>\n        <div class=\"vac-a-next\">+1 sec</div>\n    </div>\n</div>\n";
        ...
        return "<div class=\"vac-video-write-new-wrap vac-control\">\n    <div class=\"vac-video-write-new vac-is-annotation\">\n        <div>\n            <h5><b>New Annotation</b> @ " + container.escapeExpression((helper = (helper = lookupProperty(helpers, "rangeStr") || (depth0 != null ? lookupProperty(depth0, "rangeStr") : depth0)) != null ? helper : container.hooks.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : container.nullContext || {}, { "name": "rangeStr", "hash": {}, "data": data, "loc": { "start": { "line": 39, "column": 40 }, "end": { "line": 39, "column": 52 } } }) : helper)) + "</h5>\n            <div class=\"vac-comment-showbox\">\n                <textarea placeholder=\"Enter comment...\"></textarea>\n                <div>\n                    <button class=\"vac-button\">SAVE</button>\n                    <a>Cancel</a>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n";
    }, "compiler": [8, ">= 4.3.0"], "main": function main(container, depth0, helpers, partials, data) {
        var stack1,
            alias1 = depth0 != null ? depth0 : container.nullContext || {},
            lookupProperty = container.lookupProperty || function (parent, propertyName) {
...
},{"handlebars/runtime":2}],28:[function(require,module,exports){
'use strict';
...
},{"./../lib/player_ui_component":41,"./../lib/utils.js":43,"./comment":30,"./comment_list":31,"./marker":34,"./shape":37}],29:[function(require,module,exports){
'use strict';
...
},{"./../lib/player_component":40,"./../lib/utils":43,"./annotation":28}],30:[function(require,module,exports){
'use strict';
...
module.exports = function (_PlayerUIComponent) {
  ...
  function Comment(data, player) {
    ...
    _this.permissionToDeleteComment = _this.permissionToDeleteComment();
  ...
  _createClass(Comment, [{
    ...
    key: 'permissionToDeleteComment',
    value: function permissionToDeleteComment() {
...
},{"./../lib/player_ui_component":41,"./../lib/utils":43,"moment":25}],31:[function(require,module,exports){
'use strict';
...
module.exports = function (_PlayerUIComponent) {
  ...
  function CommentList(data, player) {
    ...
    _this.sortComments();
    _this.permissionToDeleteAnnotation = _this.permissionToDeleteAnnotation();
    return _this;
  }

  _createClass(CommentList, [{
    key: 'permissionToDeleteAnnotation',
    value: function permissionToDeleteAnnotation() {
...
},{"./../lib/player_ui_component":41,"./../lib/utils":43,"./comment":30}],32:[function(require,module,exports){
'use strict';
...
},{"./../lib/player_ui_component":41,"./../lib/utils":43,"./annotation":28,"./draggable_marker.js":33,"./player_button":35,"./selectable_shape.js":36}],33:[function(require,module,exports){
'use strict';
...
},{"./../lib/utils":43,"./marker":34}],34:[function(require,module,exports){
'use strict';
...
},{"./../lib/player_ui_component":41,"./../lib/utils":43}],35:[function(require,module,exports){
'use strict';
...
},{"./../lib/player_ui_component":41}],36:[function(require,module,exports){
'use strict';
...
},{"./../lib/utils":43,"./shape":37}],37:[function(require,module,exports){
'use strict';
...
},{"./../lib/player_ui_component":41}],38:[function(require,module,exports){
'use strict';
...
},{"./logger":39,"mitt":24}],39:[function(require,module,exports){
'use strict';
...
},{"../compiled/templates":27,"./player_component":40,"./utils":43,"handlebars/runtime":2}],42:[function(require,module,exports){
'use strict';
...
},{"es6-object-assign":1,"ie-array-find-polyfill":23}],43:[function(require,module,exports){
'use strict';
